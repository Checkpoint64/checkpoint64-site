...
We do not read or monitor the contents of Your Content, with one automated exception: files uploaded into a **team** namespace are scanned for malware, because a team namespace hands one member's files to another member's PC. Files in your personal namespace are **never** scanned. No person reads your files either way. This is described in Section 2.7 of our [Privacy Policy](/privacy/).
...
- **One-off plans.** The Paid and Pro plans are a one-time payment rather than a subscription, whether bought directly through Stripe or on Steam (where both are DLC you buy once and keep). A one-off plan grants the rights described in that plan for as long as the Service remains commercially available to your account. It is not a promise that the Service itself will exist forever, and it does not entitle you to features later added to a different plan tier.
- **Existing Pro subscriptions.** Pro was previously sold directly through Stripe as a recurring subscription. New Pro purchases are one-off, but any subscription started before that change continues to be billed in advance on a recurring basis until you cancel. You can cancel at any time from your account, and cancellation takes effect at the end of the current billing period.
...
- **Price changes.** We may change prices for new purchases at any time. For any subscription still active from before Pro moved to a one-off price, we will give you at least 30 days' notice before any price change takes effect; you can cancel before the new price applies.
...
On termination, your right to use the Service ends. Except where the law or a serious breach prevents it, we will give you a reasonable opportunity to export Your Content before it is removed, and will then delete it in accordance with our [Privacy Policy](/privacy/). You can export your data at any time while your account is open, and we recommend doing so before you close it.
...
**If something has gone wrong, tell us first.** Email [support@checkpoint64.com](mailto:support@checkpoint64.com) and we will try to put it right. Most problems are resolved fastest this way, and we would much rather hear about one than not.
...
Canonical HTML version: https://checkpoint64.com/terms/
