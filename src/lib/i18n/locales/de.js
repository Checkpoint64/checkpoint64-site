...
export default {
  ...
  features: {
    ...
    items: [
      ...
      { tag: '75+ SPIELE BEREIT', title: 'IN SEKUNDEN\nEINGERICHTET.', body: 'Vorlagen für 75+ Spiele — vier Spielarten von modded Minecraft, Stardew, Skyrim, Palworld, Elden Ring — plus sieben Emulatoren. Wähl, welche Dateien zählen, und überspring die Screenshots. Wenn es in einen Ordner speichert, funktioniert es.' },
  ...
  meta: {
    ...
    description: 'Automatisches Cloud-Backup und voller Versionsverlauf für PC-Spielstände. Roll kaputte Spielstände zurück und teil co-op-Welten per Sperre. Funktioniert mit Minecraft, Stardew Valley, Elden Ring und 75+ Spielen. Gratis-Download für Windows, Mac, Linux.',
    ogTitle: 'Checkpoint64 — Nie wieder einen Spielstand verlieren, solo oder co-op',
    ogDescription: 'Nie wieder einen Spielstand verlieren. Automatische Backups, voller Versionsverlauf und co-op-Sperren, damit Freunde Welten teilen, ohne sich gegenseitig zu überschreiben. 75+ Spiele bereit. Gratis-Download — einmal zahlen für mehr Platz.',
    ...
    twitterDescription: 'Nie wieder einen Spielstand verlieren. Automatische Cloud-Backups, voller Versionsverlauf, co-op-Sperren. 75+ Spiele bereit. Gratis-Download für Windows, Mac, Linux.',
  ...
  jsonld: {
    ...
    softwareDescription: 'Automatisches Cloud-Backup, voller Versionsverlauf und co-op-Sperren für PC-Spielstände. Gratis-Plan inklusive; einmal zahlen für mehr Platz. Funktioniert von Haus aus mit Minecraft, Stardew Valley, Skyrim, Palworld, Elden Ring, Factorio, Valheim sowie 75+ weiteren Spielen und 7 Emulatoren.',
    featureList: [
      ...
      'Vorlagen für 75+ Spiele und 7 Emulatoren',
