...
export default {
  ...
  features: {
    ...
    items: [
      ...
      undefined, // not translated yet — falls back to en.js at this index
      undefined, // not translated yet — falls back to en.js at this index
      { tag: "CHECKPOINT CONNECT", title: "KEINE PORT-\nWEITERLEITUNG.", body: "Lass einen Spielserver auf deinem eigenen PC laufen und teile ihn mit deinem Team. Mitspieler klicken auf Beitreten, und ihr Spiel verbindet sich direkt, wenn es geht, und sonst über ein Relay. Keine Router-Einstellungen, und nur dein Team kommt rein." },
  ...
  creators: {
    ...
    steps: [
      { label: '01 · ERSTELLEN', h3Html: 'CODE MACHEN', body: 'Öffne den Spielstand, tippe auf Gehosteter Zugang und erstell einen Code. Begrenze die Nutzungen, oder lass ihn unbegrenzt. Wie du willst. Dauert ein paar Sekunden. Geht auf jedem Tarif.' },
    ...
    points: [
      ...
      'Begrenze den Code oder widerrufe ihn jederzeit — und dein Tarif bestimmt, wie viele Fans gleichzeitig Zugang haben',
      'Nur-Lese-Fans belegen keine Plätze deines Teams',
    ],
    proNoteTpl: 'Gehostete Teilen-Codes gibt es auf jedem Tarif — 3 Nur-Lese-Fans gleichzeitig bei Gratis, 15 bei Lifetime und ganz ohne Limit bei <a href="{0}">Pro</a>, gemacht für Creator, Crews und Modding-Gruppen.',
  },
    ...
    cards: [
      ...
      },
      {
        ...
        features: [
          ...
          'tritt bis zu 5 Teams von Freunden bei',
          '1 GiB Speicher pro Bereich',
          'direkt oder über Steam kaufen',
          'niemals ein Abo',
          'Teilen-Codes für 15 Nur-Lese-Fans',
  ...
  faq: {
    ...
    items: [
      ...
      undefined, // not translated yet — falls back to en.js at this index
      undefined, // not translated yet — falls back to en.js at this index
      { q: "KANN MEIN TEAM OHNE PORTWEITERLEITUNG AUF EINEN SERVER AUF MEINEM PC?", a: "Ja, mit Checkpoint Connect. Starte den Server des Spiels auf deinem PC, teile ihn mit deinem Team, und deine Mitspieler klicken auf Beitreten. Ihr Spiel verbindet sich mit 127.0.0.1, und die beiden Apps verbinden sich direkt, wenn es geht, und sonst über ein Relay, also muss niemand an den Router. Es funktioniert für UDP- und TCP-Server, nur Mitglieder deines Teams kommen rein, und es ist in jedem Tarif enthalten." },
    ],
  },
  ...
  jsonld: {
    ...
    featureList: [
      ...
      'Checkpoint Connect — hoste einen Spielserver auf deinem eigenen PC für dein Team, ohne Portweiterleitung',
      'Volle Controller-Steuerung, auch auf dem Steam Deck',
