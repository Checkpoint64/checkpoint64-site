...
export default {
  ...
  pricing: {
    ...
    lede: 'Drei Arten zu spielen. Gratis ist wirklich gratis — kein Sieben-Tage-Test. Lifetime ist einmal zahlen. Pro ist für Crews, die zusammen sichern. Keine Gebühr pro Person, keine Überraschungskosten. Die endgültigen Preise werden noch festgezurrt — wir veröffentlichen sie hier vor dem Start.',
    badge: '★ TOP-WAHL',
    cards: [
      {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'KANN ICH ES HEUTE SCHON NUTZEN?', a: 'Ja — der frühe Build ist ab sofort gratis für Windows, macOS (Apple Silicon) und Linux verfügbar. v1 und der Steam-Release kommen später dieses Jahr.' },
