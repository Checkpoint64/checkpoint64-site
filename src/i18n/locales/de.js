...
export default {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'WAS KOSTET ES?', a: 'Der Gratis-Plan ist echt und bleibt gratis: 20 MiB, dein eigener Bereich plus ein Team. Lifetime ist eine Einmalzahlung — 5 GiB pro Bereich, bis zu 3 Teams, direkt oder über Steam gekauft. Pro ist für große Crews: 50 GiB pro Bereich, 5 Teams, je 25 Plätze, Nur-Lese-Teilen-Codes. Auf keiner Stufe Gebühr pro Person. Die endgültigen Zahlen kommen mit v1 — komm auf die Liste und sichere dir den Early-Bird-Preis.' },
