...
export default {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'WHAT DOES IT COST?', a: 'The free plan is real and stays free: 20 MiB, your own space plus one team. Lifetime is a one-time payment — 5 GiB per space, up to 3 teams, bought direct or through Steam. Pro is for big crews: 50 GiB per space, 5 teams, 25 seats each, read-only share codes. No charge per person on any tier. Final numbers land with v1 — join the list and lock in the early-bird price.' },
