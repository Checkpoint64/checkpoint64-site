...
This Privacy Policy explains what personal data **[LEGAL ENTITY]** ("**Checkpoint64**", "**we**", "**us**", "**our**") collects when you use the website at [checkpoint64.com](https://checkpoint64.com/), install the Checkpoint64 desktop app, or use the Checkpoint64 cloud backup service (together, the "**Service**"), why we collect it, who we share it with, and the rights you have over it.
