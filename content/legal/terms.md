...
Features, pricing, storage quotas, and tier names may change, and we may add, remove, or alter functionality at any time.
...
- notify us promptly at [security@checkpoint64.com](mailto:security@checkpoint64.com) if you believe your account has been compromised.
...
We do not actively monitor Your Content, but we may remove or restrict access to anything that violates these Terms, the rights of others, or applicable law.
...
- **Lifetime plans.** A "lifetime" plan is a one-time payment that grants the rights described in the plan for as long as the Service remains commercially available to that account. It is not a perpetual guarantee that the Service itself will exist forever, and it does not entitle you to features added to a different plan tier later.
- **Subscription plans (e.g. Pro).** Billed in advance on a recurring basis until you cancel. You can cancel at any time from your account; cancellation takes effect at the end of the current billing period.
- **Refunds.** For direct purchases via Stripe in the UK/EU, you have the statutory right to cancel within 14 days of purchase, except where you have started using the Service and expressly consented to that right being waived, which is the default for digital content delivered immediately. Beyond statutory rights, we may at our discretion offer goodwill refunds, but we are not obliged to. Refunds for purchases made through Steam are handled by Steam under its own refund policy.
...
The App may download and install updates automatically, including security and bug-fix updates. You consent to these updates as a condition of using the App. We may also change, suspend, or discontinue any part of the Service at any time, with or without notice, although for paid plans we will give reasonable notice of material changes.
...
**Always keep your own local copies of important save files.** Treat Checkpoint64 as an additional backup, not your only one.
...
- we will not be liable for any indirect, incidental, special, consequential, exemplary, or punitive damages, or for any loss of profits, revenue, goodwill, data, or save files, even if we have been advised of the possibility of such damages; and
...
If you are a consumer in the UK or EU, this section does not affect any non-waivable statutory rights you have.

## 14. Indemnity

You agree to indemnify and hold harmless Checkpoint64 and its officers, employees, and contractors from any claims, losses, damages, costs, and expenses (including reasonable legal fees) arising out of or relating to:
...
You may stop using the Service and close your account at any time from the account settings, or by emailing [support@checkpoint64.com](mailto:support@checkpoint64.com).
...
On termination, your right to use the Service ends immediately. We will make Your Content available for export for a reasonable period where practical, and will delete it in accordance with our [Privacy Policy](/privacy/) after that period.
...
- **Entire agreement.** These Terms, together with the [Privacy Policy](/privacy/) and any plan-specific terms presented to you at purchase, are the entire agreement between you and us about the Service.
